...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8000/auth/contact_us/",
        formData
      );
  ...
  return (
    <>
      ...
      <section
        id="contact"
        className="bg-white mx-5 rounded"
          ...
          <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
              <div>
                ...
                <p className="mt-2 font-bold text-sm text-blue-500 dark:text-blue-400">
                  prepmastery.social@gmail.com
                </p>
              </div>

              {/* //Jar bot add karycha aahe tr */}
              {/* <div>
                    <span className="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
            ...
            <div className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none btn btn-primary"
                >
                  Send message
                </button>
              </form>
